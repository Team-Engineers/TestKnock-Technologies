  ...
  return (
    <div className="w-full bg-white py-16 px-4">
      ...
      {/* <div className="flex justify-center mb-10 py-12">
        <h2 className="font-bold text-4xl">End-To-End Tech Solution</h2>
      </div>
      <div className="max-w-[1240px] mx-auto md:grid grid-cols-2 gap-4 py-10">
        <div className="shadow-xl h-[400px] w-[600px] my-4 bg-gray-200 hover:scale-90 duration-100">
          <img
            src={require("../../Assets/Images/background/web-1.jpg")}
            alt=""
          />
        </div> */}
      <div className="flex justify-center mb-10 py-12">
      ...
      <div className="max-w-[1240px] mx-auto md:grid grid-cols-2 gap-4 py-10">
        ...
        <div className="shadow-xl h-[300px] w-[500px] my-10 bg-gray-200 hover:scale-90 duration-100 overflow-hidden rounded-3xl">
          ...
          <img
            src={require("../../Assets/Images/background/mobile-1.jpg")}
            alt=""
          />
        </div>
      </div>
