    ...
    <div className="bannerHome text-white md:h-[45vw] h-[150vw] bg-[#e7d987]">
      <div className="max-w-[800px] relative top-[50%] md:top-[40%] mx-auto flex flex-col justify-center items-center">
        <div className="mt-[-96px] text-center">
          <p className="text-[white] font-bold p-2 md:text-5xl text-2xl ">Revise Smarter, Score Better:</p>
          <p className="text-[#c9c0c0] font-bold p-1 md:text-1.5xl text-1xl">with our</p>
          <h1 className="text-[white] md:text-6xl sm:text-4xl text-2xl font-bold md:p-2 w-[70vw]">
