    ...
    <div className="py-[100px] px-4 ">
      ...
      <div className="max-w-[1240px] mx-auto md:grid grid-cols-2 gap-6">
        <div className="shadow-xl  h-[400px] my-10">
          <img
            src={require("../../Assets/Images/background/work7.gif")}
            alt=""
      ...
      <div className="max-w-[1240px] mx-auto md:grid grid-cols-2 gap-6">
        <div className=" flex flex-col justify-center">
          ...
          {/* <img
            src={require("../../Assets/Images/background/tech-1.png")}
            alt=""
          /> */}
        ...
        <div className="shadow-xl  h-[300px] my-40 border border-r-2">
          <img
            src={require("../../Assets/Images/background/work10.gif")}
            alt=""
            className="w-full h-full object-cover"
          />
        </div>
      ...
      <div className="flex justify-center">
        ...
        {/* <a href="/offering" className="font-bold text-[30px]  my-2 hover:text-[green] cursor-pointer text-[black] fa fa-arrow-right">
          Get To Know More...
        </a> */}
      </div>
    </div>
