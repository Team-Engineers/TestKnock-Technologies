...
function ProdWP() {
  return (
    <div className="product_wp  mx-auto ml-[30px] mr-[30px] ">
      ...
      <p className="subheading_main mb-[20px] lg:hidden  p-2 mx-auto md:text-4xl text-4xl flex justify-center  tracking-wide">TestKnock</p>
      <div className="max-w-[1240px]  mb-[6%] mx-auto md:grid grid-cols-2 gap-10 ">
        ...
        <p className="subheading_main max-lg:hidden p-2 md:text-4xl text-4xl flex justify-center md:mb-[1vw] mb-[3vw] tracking-wide">TestKnock</p>
        <p className="text-justify xl:text-[100%] max-lg:mt-[10px] 2xl:text-[120%] text-[100%]  ">
