...
const TeamMember = ({ id, title, name, description, image }) => {
  ...
  <div className="absolute right-[-80px] top-0 transform -translate-y-1/2 z-[-1] hover:scale-0 h-[300px] w-[300px] bg-blue-200 rounded-full"></div>
  <div className="absolute left-[-80px] top-[100%] transform -translate-y-1/2 z-[-1] hover:scale-0 h-[300px] w-[300px] bg-yellow-200 rounded-full"></div>
